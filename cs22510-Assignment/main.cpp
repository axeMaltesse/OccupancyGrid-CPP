...
int main() {
    ...
    do {
        ...
        string pose;
        string range;
        cout << "I have added one more else if statement to sort out wrong order of input. \nNow you can put name of the files in different order. It is not included on the screen cast."<<endl;
